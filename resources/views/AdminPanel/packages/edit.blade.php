...
<div class="container-fluid">
    <div class="layout-specing">
        ...
        <div class="d-flex justify-content-between p-4  bg-white   rounded-top border-bottom heading-with-shape">
            <h6 class="fw-bold mb-0 h4"> تعديل باقة </h6>
        </div>
        ...
        <div class="bg-white p-4 rounded-3 mt-3">
            <form method="post" action="{{ route('admin.packages.update',['id'=>$package->id]) }}" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        <input type="text" value="{{$package->package_name_ar}}" name="package_name_ar" class="form-control   @error('package_name_ar') is-invalid @enderror" id="" placeholder="اسم الباقة بالعربية">
                    ...
                    <div class="col-6">
                        <input type="text" value="{{$package->package_name_en}}"  name="package_name_en" class="form-control   @error('package_name_en') is-invalid @enderror" id="" placeholder="اسم الباقة بالانجليزية">
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        <textarea type="text" name="package_description_ar" class="form-control   @error('package_description_ar') is-invalid @enderror" id="" placeholder="الوصف بالعربية"> {{$package->package_description_ar}} </textarea>
                    ...
                    <div class="col-6">
                        <textarea type="text" name="package_description_en" class="form-control   @error('package_description_en') is-invalid @enderror" id="" placeholder="الوصف   بالانجليزية"> {{$package->package_description_en}} </textarea>
                ...
                <div class="row mb-3">
                    <div class="col-6">
                        <input type="number" step="0.001" value="{{$package->package_price}}" name="package_price" class="form-control   @error('package_price') is-invalid @enderror" id="" placeholder="سعر الباقة">
                        @error('package_price')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="col-6">
                        <select name="package_currency" class="form-control   @error('package_currency') is-invalid @enderror" id="" placeholder="عملة الباقة">
                            ...
                            <option value="{{$currency->id}}" @if($package->package_currency == $currency->id) selected @endif> {{$currency->currency_name_ar}}</option>
                            @endforeach
                        </select>
