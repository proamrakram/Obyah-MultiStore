    ...
    <div class="layout-specing">
        ...
        <div class="bg-white mt-3">
            <div class="d-flex justify-content-between p-4  bg-white   rounded-top border-bottom heading-with-shape">
                <h6 class="fw-bold mb-0 h4"> اضافة دولة </h6>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="row mb-3 mt-4 mb-4">
                                ...
                                <div class="col-9">
                                    <input type="text" name="country_name_en" class="form-control  @error('country_name_en') is-invalid @enderror" id="rolesName" placeholder="إسم الدولة  (EN) ">
                        ...
                        <div class="col-md-8">
                            <div class="row mb-3 mt-4 mb-4">
                                ...
                                <div class="col-9">
                                    <input type="text" name="country_name_ar" class="form-control  @error('country_name_ar') is-invalid @enderror" id="rolesName" placeholder="إسم الدولة  (AR) ">
                        ...
                        <div class="col-md-8">
                            <div class="row mb-3 mt-4 mb-4">
                                ...
                                <div class="col-9">
                                    <input type="text" name="country_code" class="form-control  @error('country_code') is-invalid @enderror" id="rolesName" placeholder="اختصار الدولة ">
                                    @error('country_code')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
