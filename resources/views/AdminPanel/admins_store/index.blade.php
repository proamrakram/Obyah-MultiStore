                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="row align-items-center mb-3">
                                                    <div class="col-md-4"><label for="userName" class='font-sm'>الاسم <span
                                            ...
                                            <div class="col-md-6">
                                                <div class="row align-items-center mb-3">
                                                    <div class="col-md-4"><label for="userPhoneNumber" class='font-sm'>رقم
                                                            الهاتف <span class="text-danger">*</span></label></div>
                                                    <div class="col-md-8"> <input name="mobile_no"
                                                            value="{{ old('mobile_no') }}" type="text"
                                                            id="userPhoneNumber"
                                                            class="form-control @error('mobile_no') is-invalid @enderror"
                                                            placeholder='برجاء ادخال11 رقم'>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row align-items-center mb-3">
                                                    <div class="col-md-4"><label for="userName" class='font-sm'>البريد
                                                            الالكتروني <span class="text-danger">*</span> </label></div>
                                                    <div class="col-md-8">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row align-items-center mb-3">
                                                    <div class="col-md-4"><label for="userPhoneNumber" class='font-sm'>
                                                            الجنس </label></div>
                                                    <div class="col-md-8">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row align-items-center mb-3">
                                                    <div class="col-md-4"><label for="userPhoneNumber" class='font-sm'>
                                                            العنوان <span class="text-muted" style='font-size: 10px'>
                                                                إختياري </span></label></div>
                                                    <div class="col-md-8"> <input name="address"
                                                            value="{{ old('address') }}" type="text" id="userPhoneNumber"
                                            ...
                                            <div class="col-md-6">
                                                <div class="row align-items-center mb-3">
                                                    <div class="col-md-4"><label for="userPassowrd" class='font-sm'>
                                                            الرقم السري <span class="text-danger">*</span></label></div>
                                                    <div class="col-md-8"> <input name="password" type="password"
                                                            id="userPassowrd"
                            ...
                            <tbody>
                                ...
                                @foreach ($admins as $admin)
                                    <tr>
                                        ...
                                        <td class="text-center p-2">
                                            <span
                                                class="text-muted">{{ date('d/m/Y', strtotime($admin->created_at)) }}</span>
                                        </td>
                                            ...
                                            <div class="tools-options d-flex justify-content-center">
                                                <div class="form-check form-switch p-0 pt-1">
                                                    ...
                                                    <input class="form-check-input" type="checkbox"
                                                        onclick="window.location='{{ route('admin.admins-store.changeStatus', ['id' => $admin->id]) }}'"
                                                        id="flexSwitchCheckChecked"
                                                        @if ($admin->user_status == 'active') checked="" @endif>

                                                </div>
                                                <a href="#" onclick="return func({{ $admin->id }})"> <i
                                                        class="uil uil-edit"></i> </a>
                                                <a href="{{ route('admin.admins-store.delete', ['id' => $admin->id]) }}"
                                                    onclick="return confirm('هل انت متأكد من حذف ({{ $admin->name }})?')">
