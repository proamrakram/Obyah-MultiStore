    ...
    <div class="layout-specing">
        ...
        <div class="bg-white mt-3">
            ...
            <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row align-items-center mb-3">
                                                <div class="col-md-4"><label for="userImage" class='font-sm'> اضافة صورة مستخدم</label></div>
                                                <div class="col-md-8"> <input name="image" type="file" id="userImage" class="form-control @error('image') is-invalid @enderror">
                                                    @error('image')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                ...
                                <td class="text-end p-3">
                                    <div class="tools-options d-flex justify-content-center">
                                        <div class="form-check form-switch p-0 pt-1">
                                            ...
                                            <input class="form-check-input" type="checkbox" onclick="window.location='{{ route("admin.admins.changeStatus",["id"=>$admin->id]) }}'" id="flexSwitchCheckChecked" @if($admin->active == 1) checked="" @endif>
