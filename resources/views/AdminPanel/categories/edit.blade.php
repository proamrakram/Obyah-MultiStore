    ...
    <div class="layout-specing">
        ...
        <div class="bg-white mt-3">
            <div class="d-flex justify-content-between p-4  bg-white   rounded-top border-bottom heading-with-shape">
                <h6 class="fw-bold mb-0 h4"> تعديل التصنيف </h6>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="row mb-3 mt-4 mb-4">
                                ...
                                <div class="col-9">
                                    <input type="text" name="category_name_en" value="{{$category->category_name_en}}"  class="form-control  @error('category_name_en') is-invalid @enderror" id="rolesName" placeholder="إسم التصنيف  (EN) ">
                        ...
                        <div class="col-md-8">
                            <div class="row mb-3 mt-4 mb-4">
                                ...
                                <div class="col-9">
                                    <input type="text" name="category_name_ar"  value="{{$category->category_name_ar}}" class="form-control  @error('category_name_ar') is-invalid @enderror" id="rolesName" placeholder="إسم التصنيف  (AR) ">
                            ...
                            <div class="row mb-3 mt-4 mb-4">
                                ...
                                <div class="col-9">
                                    <select name="type" id="" class="form-control form-select @error('type') is-invalid @enderror">
                                        <option value="category" @if($category->parent_id ==0) selected @endif> تصنيف رئيسي </option>
                                        <option value="subcategory"  @if($category->parent_id > 0) selected @endif> تصنيف فرعي </option>
                                    </select>@error('type')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row mb-3 mt-4 mb-4">
                                ...
                                <div class="col-9">
                                    <select name="parent_id" id="" class="form-control form-select @error('parent_id') is-invalid @enderror">
                                        ...
                                        <option value="{{$cat->id}}" @if($cat->id == $category->parent_id) selected @endif>{{$cat->category_name_ar}} </option>
                                        @endforeach
