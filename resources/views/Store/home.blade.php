    ...
    <div class="container-fluid">
        <div class="layout-specing">
            <div class="row">
                <div class="col mt-4">
                    <a href="#!"
                        class="statistic statistic-users features feature-primary d-flex justify-content-between align-items-center rounded shadow p-4">
                        ...
                        <div class="icon text-center rounded-pill">
                            <img src="assets/images/icon/icon-group.svg" width="90" alt="">
                        </div>
                    </a>
                </div>
                <!--end col-->
                ...
                <div class="col mt-4">
                    <a href="#!"
                        class="statistic statistic-products features feature-primary d-flex justify-content-between align-items-center rounded shadow p-4">
                        <div class="flex-1 ms-3">
                            <p class="fs-5 text-dark fw-bold mb-0">
                                <span class="counter-value  text-white h1" data-target="20">20</span>
                            </p>
                            <h6 class="mb-0 text-white">اجمالي المنتجات </h6>
                        </div>
                        <div class="icon text-center rounded-pill">
                            <img src="assets/images/icon/icon-cubes.svg" width="90" alt="">
                        </div>
                    </a>
                </div>
                <!--end col-->
                <div class="col mt-4">
                    <a href="#!"
                        class="statistic statistic-visits features feature-primary d-flex justify-content-between align-items-center rounded shadow p-4">
                        <div class="flex-1 ms-3">
                            <p class="fs-5 text-dark fw-bold mb-0">
                        ...
                        <div class="icon text-center rounded-pill">
                            <img src="assets/images/icon/icon-visits.svg" width="90" alt="">
                        </div>
                    </a>
                </div>
                <!--end col-->
                                ...
                                <tr>
                                    <td class="p-3">
                                        <a href="javascript:void(0)"
                                            class="img-border-right  features feature-primary key-feature d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                <div class="icon text-center rounded-circle me-4">
                                                    <img src="assets/images/img_noti.png" class='sm-img rounded'
                                                        alt="">
                                                </div>
                                                <div class="flex-1">
                                                    <h6 class="mb-0 text-dark">اسم المتجر</h6>
                                                    <small class="text-dark">الايميل</small>
                                                    <span class="text-muted">app@dev.com</span>
                                                </div>
                                            </div>
                                        </a>
                                    </td>
                                    <td class="text-center p-3">$253</td>
                                    <td class="text-center p-3"> Smart Watch </td>
                ...
                <div class="col-xl-4 col-lg-5 mt-4 rounded">
                    <div class="card shadow border-0 card-notification">
                        ...
                        <div class="p-4" data-simplebar style="height: 365px;">
                            <a href="javascript:void(0)"
                                class="mb-4 features feature-primary key-feature d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    <div class="icon text-center rounded-circle me-4">
                                        <img src="assets/images/img_noti.png" class='sm-img rounded' alt="">
                                    </div>
                                    <div class="flex-1">
                                        <h6 class="mb-0 text-dark">اسم المتجر</h6>
