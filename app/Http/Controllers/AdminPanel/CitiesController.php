...
class CitiesController extends Controller
{
  ...
  {
    $cities = City::where('is_delete',0)->paginate(10);
  ...
  public function edit($id)
  {
    ...
    if(is_null($city) || $city->is_delete == 1) {
      session()->flash('error', 'المدينة غير موجودة');
  ...
  public function update(Request $request, $id)
  {
    ...
    session()->flash('success', 'تم تعديل بيانات المدينة  بنجاح');
    return redirect()->route('admin.cities.index');
  }
  ...
  public function change_status($id)
  {
    ...
    $city->save();
    session()->flash('success', 'تم تغيير حالة المدينة بنجاح');
    return redirect()->back();
  }
}
